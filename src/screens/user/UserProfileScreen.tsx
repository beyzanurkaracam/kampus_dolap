...
const getAvatarUrl = (url?: string) => {
  ...
  // Eğer Android'deysek ve URL localhost içeriyorsa, onu 10.0.2.2 yap
  ...
  const renderProfileHeader = () => (
    <View style={styles.profileContainer}>
        ...
        <View style={styles.avatarWrapper}>
            {isOwner ? (
                 <AvatarPicker 
                    avatarUrl={getAvatarUrl(profile?.profilePhoto) || undefined}
                ...
                profile?.profilePhoto ? (
                    <Image source={{ uri: getAvatarUrl(profile.profilePhoto)! }} style={styles.avatar} />
                ) : (
